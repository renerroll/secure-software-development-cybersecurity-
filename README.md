...
| Package | Version (тест) | Транзитивні залежності | # CVE | Середній CVSS | Найвища EPSS | Рівень гігієни (Scorecard) | Ознаки ризику (Socket.dev) | Ліцензія | Рекомендація |
|---|---:|---:|---:|---:|---:|---:|---|---|---|
| `uuid` | `3.4.0` | 0 | 0 | — | — | **4.7 / 10** | Socket.dev page not available — package.json shows no install‑scripts (low risk) | MIT | Оновити до останньої мажорної версії (v7+) і тестувати ✅ |
| `nanoid` | `2.1.0` | 0 | 1 | 4.3 | 0.00116 | **3.6 / 10** | Socket.dev page not available — advisory **GHSA‑mwcw‑c2x4‑8c55** (predictable generation for non‑integer inputs) | MIT | Оновити до ≥3.3.8 (або останню версію) та додати SCA‑check у CI ⚠️ |
